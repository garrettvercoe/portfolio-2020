...
export default class ListYear extends React.Component {
  constructor(props) {
    ...
    this.projectsOrdered = this.props.projects.sort((a, b) =>
      a.node.project_post_date > b.node.project_post_date ? 1 : -1
    )
  }
  onFilter(category) {
    ...
    return (
      <>
        <ListWrapper>
          ...
          <Breaker>—</Breaker>
          {this.projectsOrdered.map((project, i) =>
